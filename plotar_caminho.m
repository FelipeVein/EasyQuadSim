...
% % 
for(i = 1:150:length(salvar.x_plot))
% for(i = 50:35:175)
...
hold on
plot3(salvar.x_des_plot(1:end),salvar.y_des_plot(1:end),salvar.z_des_plot(1:end),'--k')
grid
% plot3(salvar.x_plot(50:175),salvar.y_plot(50:175),salvar.z_plot(50:175),'k')
% hold on
% plot3(salvar.x_des_plot(50:175),salvar.y_des_plot(50:175),salvar.z_des_plot(50:175),'--k')
% grid
xlabel('X[m]')
ylabel('Y[m]')
zlabel('Z[m]')